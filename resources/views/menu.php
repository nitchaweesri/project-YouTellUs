...
<div class="container mb-4 col-lg-7 col-md-12 col-sm-12" id="menu">
    <div class="row justify-content-end">
        <div class="col-lg-8 col-md-10 col-sm-10">
            <h3 class="text-secondary text-right mt-5 Regular">กรุณาระบุประเภทการร้องเรียน</h3>
        </div>
    </div>
    <?php 
    foreach ($result as $key => $value) {
        ...
        echo '<div class="row mt-3 justify-content-md-center justify-content-sm-center">
                <div class="col-lg-8 col-md-8 col-sm-10">
                    <a href="index.php?page='. $page_vl .'" class="btn btn-lg btn-primary rounded d-flex justify-content-center Regular">
                        '. $name_vl .'
                    </a>
                </div>
            </div>';
